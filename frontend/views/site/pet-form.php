...
<div class="site-pet-form">
    ...
    <?php $form = ActiveForm::begin(); ?>
        <?= $form->field($pet, 'PetName')->textInput(['maxlength' => true]) ?>
        <?= $form->field($pet, 'Gender')->dropDownList(['公' => '公', '母' => '母'], ['prompt' => '选择性别']) ?>
        <div class="row">
            <div class="col-sm-6">
                <?= $form->field($pet, 'AgeYears')->textInput(['type' => 'number', 'min' => 0]) ?>
            </div>
            <div class="col-sm-6">
                <?= $form->field($pet, 'AgeMonths')->textInput(['type' => 'number', 'min' => 0, 'max' => 11]) ?>
            </div>
        </div>
        <?= $form->field($pet, 'HealthStatus')->textInput(['maxlength' => true]) ?>
